...
import com.example.dz_3_3.controller.StudentController;
...
public class SchoolTest {
    ...
    public void testPostStudent() {
        Student student = givenStudent("Kate", 24);
    ...
    public void testFindByAge() {
        Student student_28 = givenStudent("student1", 28);
        Student student_24 = givenStudent("student2", 24);
        Student student_36 = givenStudent("student3", 36);
        Student student_50 = givenStudent("student4", 50);

        whenSendingCreateStudentRequest(getUriBuilder().build().toUri(), student_28);
        whenSendingCreateStudentRequest(getUriBuilder().build().toUri(), student_24);
        whenSendingCreateStudentRequest(getUriBuilder().build().toUri(), student_36);
        whenSendingCreateStudentRequest(getUriBuilder().build().toUri(), student_50);
    ...
    public void testFindByAgeBetween() {
        ...
        MultiValueMap<String, String> queryParams = new LinkedMultiValueMap<>();
        queryParams.add("minAge", "18");
        queryParams.add("maxAge", "45");
        thenStudentsAreFoundByCriteria(queryParams, student_24, student_36);
    }
    ...
    public void testUpdate() {
        Student student = givenStudent("Kate", 25);
        ...
        whenUpdatingStudent(createdStudent, 48, "Irina");
        thenStudentHasBeenUpdated(createdStudent, 48, "Irina");
    }
    ...
    public void testDelete() {
        Student student = givenStudent("Boris", 31);
